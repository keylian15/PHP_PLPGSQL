<div class="dtitle w3-container w3-teal">
    Modification de l'étudiant n° <?= htmlspecialchars($etudiant->numetu ?? "") ?>
</div>
            ...
            <form class="w3-container" method="POST" action="<?= $_SERVER["REQUEST_URI"] ?>">
                ...
                <div class="dcontent">
                    <div class="w3-row-padding">
                        <div class="w3-third">
                            ...
                            <input type="text" id="adretu" name="adretu" placeholder="Entrer une adretue" value="<?= htmlspecialchars($etudiant->adretu ?? "") ?>">
                        </div>
                ...
                <div class="dcontent">
                    <div class="w3-row-padding">
                        ...
                        <div class="w3-third">
                            ...
                            <input type="text" id="
                            " name="annetu" placeholder="Entrer l'année d'étude" value="<?= htmlspecialchars($etudiant->annetu > 0 ? $etudiant->annetu : "") ?>">
                        </div>

                        <div class="w3-third">
                            <label class="w3-text-blue" for="tittle">Numéro de téléphone</label>
                ...
                <div class="dcontent">
                    <div class="w3-row-padding">
                        ...
                        <div class="w3-third">
                            <label class="w3-text-blue" for="tittle">Sexe</label>
